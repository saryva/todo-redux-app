...
export const editar = createAction('[TODO] Editar Todo', props<{ id: number; textoToEdit: string }>());
export const borrar = createAction('[TODO] Borrar Todo', props<{ id: number }>());
export const toggleAll = createAction('[TODO] ToggleAll Todo', props<{ isToggleAll: boolean }>());
